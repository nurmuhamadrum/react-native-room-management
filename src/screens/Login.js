...
export default class Login extends Component {
    ...
    handleButtonFunction = () => {
        axios({
            method: 'POST',
            url: `http://192.168.1.41:3000/api/v2/login`,
            data: {
            ...
            if (this.state.token) {
                ...
                alert('this is alert') // this.setState({ isModalVisible: true })
            }
        }).catch((err) => {
        ...
        return (
            <ImageBackground source={bgImage} style={style.backgroundContainer}>
                ...
                <View style={style.inputContainer}>
                    ...
                    />
                    <Icon name="user-circle" color={'grey'} size={24}
                ...
                <View style={style.inputContainer}>
                    ...
                    <Icon name="lock" color={'grey'} size={24}
                        style={style.inputIcon} />
                    <Icon style={style.eyeIcon} name={this.state.icon}
                        onPress={() => this.changeIcon()} />
                </View>

                <TouchableOpacity style={style.btnLoggin} onPress={() => this.handleButtonFunction()}>
